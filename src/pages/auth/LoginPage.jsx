        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-8">
          ...
          <div className="space-y-4 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center px-6 py-4 bg-white border-2 border-gray-200 rounded-xl shadow-sm text-base font-medium text-gray-700 hover:border-primary-500 hover:shadow-lg hover:bg-primary-50 focus:outline-none focus:ring-4 focus:ring-primary-500/20 transition-all duration-300 transform hover:-translate-y-0.5"
            >
              <svg 
                className={`w-6 h-6 mr-3 transition-transform duration-300 ${isHovered ? 'scale-110' : ''}`} 
                viewBox="0 0 24 24"
              >
                <path
                  fill="#4285F4"
