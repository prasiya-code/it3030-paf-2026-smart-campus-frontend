...
const ResourceListPage = () => {
  ...
  // Role detection - in production this would come from auth context or API
  // For now, checking localStorage or defaulting to 'user'
  const [userRole, setUserRole] = useState(() => {
    // Check if role is stored in localStorage (for demo purposes)
    const storedRole = localStorage.getItem('userRole');
    return storedRole || 'user'; // Default to 'user' if no role stored
  });
